...
insert  into `barang_masuk`(`id_masuk`,`id_supplier`,`tgl_masuk`) values ('TR001','SUP002','0000-00-00');
...
insert  into `detail_masuk`(`id`,`id_masuk`,`id_barang`,`qty`,`id_supplier`) values (1,'TR001','BRG004',322,'SUP002'),(2,'TR001','BRG004',322,'SUP002'),(3,'TR001','BRG007',1,'SUP002'),(4,'TR001','BRG003',1,'SUP002');
